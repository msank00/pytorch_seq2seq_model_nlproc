...
def trainIters(encoder, decoder,input_lang, output_lang,device, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
...
print("saving hyper-parameter in json...")
dict_param = {"hidden_size": hidden_size, 
...
trainIters(encoder1, attn_decoder1,input_lang, output_lang, device, n_iters=400, print_every=20, plot_every=2)
